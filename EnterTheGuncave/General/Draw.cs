...
namespace EnterTheGuncave.General
{
	public class DrawUtils
	{
		...
		public void drawGrid(Color color)
		{
			...
			for (int x = 0; x <= EnterTheGuncave.roomWidth; x++)
			{
				for (int y = 0; y <= EnterTheGuncave.roomWidth; y++)
				{
					drawRectangle(new Rectangle(x * EnterTheGuncave.tileSize, y * EnterTheGuncave.tileSize,EnterTheGuncave.tileSize, EnterTheGuncave.tileSize), color, false);
				}
			}
		}
