...
namespace RGM.General.Graphics
{
    public class DrawUtils
    {
        ...
        public void drawLine(int x1, int y1, int x2, int y2, Color color)
        {
            ...
            (double y_s_line_a, double y_s_line_b) = Y_streight_line(x1, y1, x2, y2);
            (double x_s_line_a, double x_s_line_b) = X_streight_line(x1, y1, x2, y2);

            if (Math.Abs(y_s_line_a) < Math.Abs(x_s_line_a))
            {
                Y_draw_line(y1, y2, y_s_line_a, y_s_line_b, color);
            }
            else
            {
                X_draw_line(x1, x2, x_s_line_a, x_s_line_b, color);
            }
        }

        // X - clasic coordinates

        private (double, double) X_streight_line(int x1, int y1, int x2, int y2)
        {
            try
            {
        ...
        private int X_f(int x, double a, double b)
        {
            int y = (int)(a * x + b);
            return y;
        }

        private void X_draw_line(int x1, int x2, double a, double b, Color color)
        {
            ...
            {
                drawPixel(x, X_f(x, a, b), color);
            }
        }

        // Y - rotated coordinates

        private (double, double) Y_streight_line(int x1, int y1, int x2, int y2)
        {
            try
            {
        ...
        private int Y_f(int y, double a, double b)
        {
            int x = (int)(a * y + b);
            return x;
        }
        ...
        private void Y_draw_line(int y1, int y2, double a, double b, Color color)
        {
